...
import (
	...
	app2 "github.com/hongkailiu/test-go/pkg/experimental/codegen/pkg/client/informers/externalversions/app"
...
func (f *sharedInformerFactory) App() app2.Interface {
	return app2.New(f, f.namespace, f.tweakListOptions)
}
