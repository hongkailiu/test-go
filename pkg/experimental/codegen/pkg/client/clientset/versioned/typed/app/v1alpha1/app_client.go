...
func (c *AppV1alpha1Client) SVTGos(namespace string) SVTGoInterface {
	return newSVTGos(c, namespace)
}
...
func setConfigDefaults(config *rest.Config) error {
	gv := v1alpha12.SchemeGroupVersion
	config.GroupVersion = &gv
	config.APIPath = "/apis"
	config.NegotiatedSerializer = serializer.DirectCodecFactory{CodecFactory: scheme2.Codecs}
